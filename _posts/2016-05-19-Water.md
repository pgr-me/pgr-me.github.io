...
<iframe width="100%" height="400" frameborder="0" src="https://peter-gray-rasmussen.cartodb.com/viz/eadb8856-1dfa-11e6-add5-0e787de82d45/embed_map" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>

## Selecting the right clustering method

It often makes sense to split univariate data into quintiles, such as in We should select thWe can score Jenks clusters using a statistic called the goodness of variance fit (GVF), which runs from 0 (poorest fit) to 1 (perfect fit). The Jenks GVF was  approximately 0.9, while the quintile GVF was about 0.7. 
